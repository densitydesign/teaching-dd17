...
1. *Michele Mauri.* Introduction to data visualization, information visualization, information design
2. *Gabriele Colombo.* Issue mapping with Digital Methods
3. *Ángeles Briones.* Data publics
4. *Salvatore Zingale.* Semiotics
5. *Simone Vantini.* Statistics

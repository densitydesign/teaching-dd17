...
(function (a) {
  ...
  var b = {},
    c = function (a) {
      ...
      for (
        b[this.id] = this,
          this.settings = new c.classes.configurable(
            c.settings,
            j.settings || {}
          ),
      ...
      for (f = j.middlewares || [], d = 0, e = f.length; e > d; d++)
        this.middlewares.push(
          "string" == typeof f[d] ? c.middlewares[f[d]] : f[d]
        );
      "object" == typeof j.graph &&
        j.graph &&
        (this.graph.read(j.graph), this.refresh()),
        window.addEventListener("resize", function () {
          i.settings && i.refresh();
        });
    };
  if (
    ((c.prototype.addCamera = function (b) {
      var d,
        e = this;
      if (!arguments.length) {
    ...
    (c.prototype.killCamera = function (a) {
      ...
      return (
        delete this.renderersPerCamera[a.id],
    ...
    (c.prototype.addRenderer = function (a) {
      ...
      if (
        ("string" == typeof g
          ? (g = { container: document.getElementById(g) })
          : g instanceof HTMLElement && (g = { container: g }),
        "string" == typeof g.container &&
          (g.container = document.getElementById(g.container)),
        "id" in g)
      )
        b = g.id;
      else {
      ...
      if (
        ((d = "function" == typeof g.type ? g.type : c.renderers[g.type]),
        (d = d || c.renderers.def),
        (e =
          "camera" in g
            ? g.camera instanceof c.classes.camera
              ? g.camera
              : this.cameras[g.camera] || this.addCamera(g.camera)
            : this.addCamera()),
        this.cameras[e.id] !== e)
      )
        throw "sigma.addRenderer: The camera is not properly referenced.";
      return (
        (f = new d(this.graph, e, this.settings, g)),
        (this.renderers[b] = f),
        Object.defineProperty(f, "id", { value: b }),
        f.bind &&
          f.bind(
            [
              "click",
    ...
    (c.prototype.refresh = function (b) {
      var d,
        ...
        j = 0;
      for (
        b = b || {}, g = this.middlewares || [], d = 0, e = g.length;
        e > d;
        d++
      )
        g[d].call(
      ...
      for (f in this.cameras)
        (h = this.cameras[f]),
          h.settings("autoRescale") &&
          this.renderersPerCamera[h.id] &&
          this.renderersPerCamera[h.id].length
            ? c.middlewares.rescale.call(
                this,
                g.length ? "ready:" : "",
                h.readPrefix,
                {
            ...
            : c.middlewares.copy.call(
                this,
                g.length ? "ready:" : "",
                h.readPrefix
              ),
          b.skipIndexation ||
            ((i = c.utils.getBoundaries(this.graph, h.readPrefix)),
            h.quadtree.index(this.graph.nodes(), {
              prefix: h.readPrefix,
              bounds: {
                x: i.minX,
                y: i.minY,
            ...
            h.edgequadtree !== a &&
              h.settings("drawEdges") &&
              h.settings("enableEdgeHovering") &&
              h.edgequadtree.index(this.graph, {
                prefix: h.readPrefix,
                bounds: {
                  x: i.minX,
                  y: i.minY,
        ...
        if (this.renderers[g[d]].process)
          if (this.settings("skipErrors"))
            try {
              ...
              console.log(
                'Warning: The renderer "' + g[d] + '" crashed on ".process()"'
              );
            }
        ...
        if (this.settings("skipErrors"))
          try {
            ...
            this.settings("verbose") &&
              console.log(
                'Warning: The renderer "' + c[a] + '" crashed on ".render()"'
              );
          }
  ...
  (function (a) {
    ...
    function b(a, c) {
      ...
      if (arguments.length)
        if (1 === arguments.length && Object(arguments[0]) === arguments[0])
          ...
          for (
            g = Array.isArray(a) ? a : a.split(/ /), d = 0, e = g.length;
            d !== e;
            d += 1
          )
    ...
    function c(a, b) {
      ...
      if (arguments.length)
        ...
        else for (c = 0, d = i.length; c !== d; c += 1) delete C[i[c]];
    ...
    function d(a, b) {
      ...
      for (b = void 0 === b ? {} : b, c = 0, e = i.length; c !== e; c += 1)
        if (((h = i[c]), C[h]))
          for (
            g = { type: h, data: b || {} }, d = 0, f = C[h].length;
            d !== f;
            d += 1
          )
            try {
    ...
    function h(a, b) {
      ...
      if (Array.isArray(a)) {
        ...
        if (k(a))
          throw new Error(
            '[conrad.addJob] Job with id "' + a + '" already exists.'
          );
    ...
    function i(a) {
      var b,
        ...
        f,
        g = !1;
      if (Array.isArray(a)) for (b = 0, c = a.length; c > b; b++) i(a[b]);
      else {
        if ("string" != typeof a)
          throw new Error("[conrad.killJob] Wrong arguments.");
        for (e = [w, y, v], b = 0, c = e.length; c > b; b++)
          a in e[b] &&
            ((f = e[b][a]),
            B.history && ((f.status = "done"), z.push(f)),
            d("jobEnded", q(f)),
            delete e[b][a],
  ...
  function (a) {
    ...
    (sigma.utils.floatColor = function (a) {
      ...
      "#" === a[0]
        ? ((a = a.slice(1)),
          3 === a.length
            ? ((d = parseInt(a.charAt(0) + a.charAt(0), 16)),
              (e = parseInt(a.charAt(1) + a.charAt(1), 16)),
              (f = parseInt(a.charAt(2) + a.charAt(2), 16)))
            : ((d = parseInt(a.charAt(0) + a.charAt(1), 16)),
              (e = parseInt(a.charAt(2) + a.charAt(3), 16)),
              (f = parseInt(a.charAt(4) + a.charAt(5), 16))))
        : a.match(/^ *rgba? *\(/) &&
          ((a = a.match(
            /^ *rgba? *\( *([0-9]*) *, *([0-9]*) *, *([0-9]*) *(,.*)?\) *$/
          )),
      ...
      (sigma.utils.zoomTo = function (a, b, c, d, e) {
        ...
        (g = Math.max(i("zoomMin"), Math.min(i("zoomMax"), a.ratio * d))),
          g !== a.ratio &&
            ((d = g / a.ratio),
            (h = { x: b * (1 - d) + a.x, y: c * (1 - d) + a.y, ratio: g }),
            e && e.duration
              ? ((f = sigma.misc.animation.killAll(a)),
                (e = sigma.utils.extend(e, {
                  easing: f ? "quadraticOut" : "quadraticInOut",
                })),
                sigma.misc.animation.camera(a, h, e))
              : (a.goTo(h), e && e.onComplete && e.onComplete()));
      }),
      (sigma.utils.getQuadraticControlPoint = function (a, b, c, d) {
        return { x: (a + c) / 2 + (d - b) / 4, y: (b + d) / 2 + (a - c) / 4 };
      }),
      ...
      (sigma.utils.getSelfLoopControlPoints = function (a, b, c) {
        return { x1: a - 7 * c, y1: b, x2: a, y2: b + 7 * c };
      }),
      ...
      (sigma.utils.getCircleIntersection = function (a, b, c, d, e, f) {
        ...
        if (
          ((h = d - a), (i = e - b), (j = Math.sqrt(i * i + h * h)), j > c + f)
        )
          return !1;
        ...
        var p = n + l,
          ...
          r = o + m,
          s = o - m;
        return { xi: p, xi_prime: q, yi: r, yi_prime: s };
      }),
      ...
      (sigma.utils.isPointOnQuadraticCurve = function (
        ...
        for (
          var k,
            l = sigma.utils.getDistance(a, b, c, d),
            m = sigma.utils.getDistance(a, b, e, f),
            n = 0.5,
            o = m > l ? -0.01 : 0.01,
            p = 0.001,
            q = 100,
            r = sigma.utils.getPointOnQuadraticCurve(n, c, d, e, f, g, h),
            s = sigma.utils.getDistance(a, b, r.x, r.y);
          q-- > 0 && n >= 0 && 1 >= n && s > i && (o > p || -p > o);
      ...
      (sigma.utils.isPointOnBezierCurve = function (
        ...
        for (
          var m,
            n = sigma.utils.getDistance(a, b, c, d),
            o = sigma.utils.getDistance(a, b, e, f),
            p = 0.5,
            q = o > n ? -0.01 : 0.01,
            r = 0.001,
            s = 100,
            t = sigma.utils.getPointOnBezierCurve(p, c, d, e, f, g, h, i, j),
            u = sigma.utils.getDistance(a, b, t.x, t.y);
          s-- > 0 && p >= 0 && 1 >= p && u > k && (q > r || -r > q);
      ...
      (sigma.utils.getX = function (b) {
        return (
          (b.offsetX !== a && b.offsetX) ||
          (b.layerX !== a && b.layerX) ||
          (b.clientX !== a && b.clientX)
        );
      }),
      (sigma.utils.getY = function (b) {
        return (
          (b.offsetY !== a && b.offsetY) ||
          (b.layerY !== a && b.layerY) ||
          (b.clientY !== a && b.clientY)
        );
      }),
      (sigma.utils.getPixelRatio = function () {
        var b = 1;
        return (
          window.screen.deviceXDPI !== a &&
          window.screen.logicalXDPI !== a &&
          window.screen.deviceXDPI > window.screen.logicalXDPI
            ? (b = window.screen.systemXDPI / window.screen.logicalXDPI)
            : window.devicePixelRatio !== a && (b = window.devicePixelRatio),
          b
        );
      }),
      (sigma.utils.getWidth = function (b) {
        var c = b.target.ownerSVGElement
          ? b.target.ownerSVGElement.width
          : b.target.width;
        return (
          ("number" == typeof c && c) ||
          (c !== a && c.baseVal !== a && c.baseVal.value)
        );
      }),
      (sigma.utils.getCenter = function (a) {
        var b =
          -1 !== a.target.namespaceURI.indexOf("svg")
            ? 1
      ...
      (sigma.utils.getHeight = function (b) {
        var c = b.target.ownerSVGElement
          ? b.target.ownerSVGElement.height
          : b.target.height;
        return (
          ("number" == typeof c && c) ||
          (c !== a && c.baseVal !== a && c.baseVal.value)
      ...
      (sigma.utils.getDelta = function (b) {
        return (
          (b.wheelDelta !== a && b.wheelDelta) || (b.detail !== a && -b.detail)
        );
      }),
      ...
      (sigma.utils.loadShader = function (a, b, c, d) {
        ...
        return (
          ...
          e
            ...
            : (d &&
                d(
                  'Error compiling shader "' + f + '":' + a.getShaderInfoLog(f)
                ),
              a.deleteShader(f),
              null)
        );
      ...
      (sigma.utils.loadProgram = function (a, b, c, d, e) {
        ...
        return (
          ...
          g
            ? h
            : (e && e("Error in program linking: " + a.getProgramInfoLog(h)),
              a.deleteProgram(h),
              null)
        );
      }),
      ...
      (sigma.utils.matrices.multiply = function (a, b, c) {
        var d = c ? 2 : 3,
          ...
          v = b[2 * d + 2];
        return c
          ? [e * n + f * q, e * o + f * r, h * n + i * q, h * o + i * r]
          : [
              e * n + f * q + g * t,
              e * o + f * r + g * u,
              e * p + f * s + g * v,
  ...
  (function (a) {
    ...
    for (b = 0; b < d.length && !a.requestAnimationFrame; b++)
      (a.requestAnimationFrame = a[d[b] + "RequestAnimationFrame"]),
        (a.cancelAnimationFrame =
          a[d[b] + "CancelAnimationFrame"] ||
          a[d[b] + "CancelRequestAnimationFrame"]);
  ...
  function () {
    ...
    (a.prototype.bind = function (a, b) {
      ...
      if (1 === arguments.length && "object" == typeof arguments[0])
        ...
        for (
          f = "string" == typeof a ? a.split(" ") : a, c = 0, d = f.length;
          c !== d;
          c += 1
        )
          (e = f[c]),
            e &&
              ...
              this._handlers[e].push({ handler: b }));
      }
      return this;
    }),
          ...
          for (c = 0, d = j.length; c !== d; c += 1) {
            if (((i = j[c]), this._handlers[i])) {
              for (h = [], e = 0, f = this._handlers[i].length; e !== f; e += 1)
                this._handlers[i][e].handler !== b &&
                  h.push(this._handlers[i][e]);
              this._handlers[i] = h;
            }
            this._handlers[i] &&
              0 === this._handlers[i].length &&
      ...
      (a.prototype.dispatchEvent = function (a, b) {
        ...
        for (b = void 0 === b ? {} : b, c = 0, d = k.length; c !== d; c += 1)
          if (((i = k[c]), this._handlers[i])) {
            for (
              h = j.getEvent(i, b), g = [], e = 0, f = this._handlers[i].length;
              e !== f;
              e += 1
            )
      ...
      "undefined" != typeof this.sigma
        ? ((this.sigma.classes = this.sigma.classes || {}),
          (this.sigma.classes.dispatcher = a))
        : "undefined" != typeof exports
        ? ("undefined" != typeof module &&
            module.exports &&
            (exports = module.exports = a),
          (exports.dispatcher = a))
        : (this.dispatcher = a);
  }.call(this),
  function () {
    "use strict";
    ...
    "undefined" != typeof this.sigma
      ? ((this.sigma.classes = this.sigma.classes || {}),
        (this.sigma.classes.configurable = a))
      : "undefined" != typeof exports
      ? ("undefined" != typeof module &&
          module.exports &&
          (exports = module.exports = a),
        (exports.configurable = a))
      : (this.configurable = a);
  }.call(this),
  function () {
    "use strict";
    ...
    (j.addMethod = function (a, b) {
      ...
      j.addMethod("addNode", function (a) {
        ...
        var b,
          c = a.id,
          d = Object.create(null);
        if (this.settings("clone")) for (b in a) "id" !== b && (d[b] = a[b]);
        else d = a;
        return (
          this.settings("immutable")
            ? Object.defineProperty(d, "id", { value: c, enumerable: !0 })
            : (d.id = c),
      ...
      j.addMethod("addEdge", function (a) {
        ...
        if (
          ("string" != typeof a.source && "number" != typeof a.source) ||
          !this.nodesIndex[a.source]
        )
          throw "The edge source must have an existing node id.";
        if (
          ("string" != typeof a.target && "number" != typeof a.target) ||
          !this.nodesIndex[a.target]
        )
        ...
        return (
          this.settings("immutable")
            ? (Object.defineProperty(c, "id", { value: a.id, enumerable: !0 }),
          ...
          this.inNeighborsIndex[c.target][c.source] ||
            (this.inNeighborsIndex[c.target][c.source] = Object.create(null)),
          (this.inNeighborsIndex[c.target][c.source][c.id] = c),
          this.outNeighborsIndex[c.source][c.target] ||
            (this.outNeighborsIndex[c.source][c.target] = Object.create(null)),
          (this.outNeighborsIndex[c.source][c.target][c.id] = c),
          this.allNeighborsIndex[c.source][c.target] ||
            (this.allNeighborsIndex[c.source][c.target] = Object.create(null)),
          (this.allNeighborsIndex[c.source][c.target][c.id] = c),
          c.target !== c.source &&
            (this.allNeighborsIndex[c.target][c.source] ||
              (this.allNeighborsIndex[c.target][c.source] =
                Object.create(null)),
            (this.allNeighborsIndex[c.target][c.source][c.id] = c)),
      ...
      j.addMethod("dropNode", function (a) {
        ...
        var b, c, d;
        for (
          delete this.nodesIndex[a], b = 0, d = this.nodesArray.length;
          d > b;
          b++
        )
        ...
        for (b = this.edgesArray.length - 1; b >= 0; b--)
          (this.edgesArray[b].source === a ||
            this.edgesArray[b].target === a) &&
            this.dropEdge(this.edgesArray[b].id);
      ...
      j.addMethod("dropEdge", function (a) {
        ...
        return (
          delete this.inNeighborsIndex[d.target][d.source][d.id],
          Object.keys(this.inNeighborsIndex[d.target][d.source]).length ||
            delete this.inNeighborsIndex[d.target][d.source],
          delete this.outNeighborsIndex[d.source][d.target][d.id],
          Object.keys(this.outNeighborsIndex[d.source][d.target]).length ||
            delete this.outNeighborsIndex[d.source][d.target],
          delete this.allNeighborsIndex[d.source][d.target][d.id],
          Object.keys(this.allNeighborsIndex[d.source][d.target]).length ||
            delete this.allNeighborsIndex[d.source][d.target],
          d.target !== d.source &&
            (delete this.allNeighborsIndex[d.target][d.source][d.id],
            Object.keys(this.allNeighborsIndex[d.target][d.source]).length ||
              delete this.allNeighborsIndex[d.target][d.source]),
    ...
    sigma.utils.pkg("sigma.classes"),
      (sigma.classes.camera = function (a, b, c, d) {
        sigma.classes.dispatcher.extend(this),
          Object.defineProperty(this, "graph", { value: b }),
          Object.defineProperty(this, "id", { value: a }),
          Object.defineProperty(this, "readPrefix", {
            value: "read_cam" + a + ":",
          }),
          Object.defineProperty(this, "prefix", { value: "cam" + a + ":" }),
          (this.x = 0),
          (this.y = 0),
          (this.ratio = 1),
          (this.angle = 0),
      ...
      (sigma.classes.camera.prototype.graphPosition = function (a, b, c) {
        ...
        return (
          c ||
            ((d = -(this.x * f + this.y * g) / this.ratio),
      ...
      (sigma.classes.camera.prototype.getMatrix = function () {
        var a = sigma.utils.matrices.scale(1 / this.ratio),
          ...
          d = sigma.utils.matrices.multiply(
            c,
            sigma.utils.matrices.multiply(b, a)
          );
        return d;
      }),
  ...
  function (a) {
    ...
    var j = {
        ...
        lowerLeftCoor: function (a) {
          var b = Math.sqrt(
            Math.pow(a.x2 - a.x1, 2) + Math.pow(a.y2 - a.y1, 2)
          );
          return {
        ...
        lowerRightCoor: function (a, b) {
          return { x: b.x - a.x1 + a.x2, y: b.y - a.y1 + a.y2 };
        },
        ...
        axis: function (a, b) {
          return [
            ...
            { x: a[1].x - a[3].x, y: a[1].y - a[3].y },
            { x: b[0].x - b[2].x, y: b[0].y - b[2].y },
            { x: b[0].x - b[1].x, y: b[0].y - b[1].y },
          ];
        },
        projection: function (a, b) {
          var c =
            (a.x * b.x + a.y * b.y) / (Math.pow(b.x, 2) + Math.pow(b.y, 2));
          return { x: c * b.x, y: c * b.y };
        },
    ...
    (k.prototype.index = function (a, b) {
      ...
      (k.prototype.point = function (a, b) {
        return this._tree ? g({ x: a, y: b }, this._tree) || [] : [];
      }),
      (k.prototype.area = function (a) {
        ...
        j.isAxisAligned(a)
          ? ((b = c), (e = j.axisAlignedTopPoints(a)))
          : ((b = d), (e = j.rectangleCorners(a)));
  ...
  function (a) {
    ...
    (k.prototype.index = function (a, b) {
      ...
      for (var l = a.edges(), m = 0, n = l.length; n > m; m++)
        (d = a.nodes(l[m].source)),
          (e = a.nodes(l[m].target)),
          (h = {
            x1: d[k + "x"],
            y1: d[k + "y"],
            x2: e[k + "x"],
          ...
          "curve" === l[m].type || "curvedArrow" === l[m].type
            ? d.id === e.id
              ? ((g = {
                  x: d[k + "x"],
                  y: d[k + "y"],
                ...
                f(l[m], j.selfLoopToSquare(g), this._tree))
              : ((c = sigma.utils.getQuadraticControlPoint(
                  h.x1,
                  h.y1,
                  h.x2,
                  h.y2
                )),
                f(l[m], j.quadraticCurveToSquare(h, c), this._tree))
            : f(l[m], j.lineToSquare(h), this._tree);
      return (this._cache = { query: !1, result: !1 }), this._tree;
    }),
      (k.prototype.point = function (a, b) {
        return this._enabled && this._tree
          ? g({ x: a, y: b }, this._tree) || []
          : [];
      }),
      (k.prototype.area = function (a) {
  ...
  function () {
    ...
    sigma.utils.pkg("sigma.captors"),
      (sigma.captors.mouse = function (a, b, c) {
        function d(a) {
          var b, c, d;
          return y("mouseEnabled") &&
            (v.dispatchEvent("mousemove", sigma.utils.mouseCoords(a)), q)
            ? ((r = !0),
              (s = !0),
              u && clearTimeout(u),
              ...
              sigma.misc.animation.killAll(x),
              (x.isMoving = !0),
              (d = x.cameraPosition(
                sigma.utils.getX(a) - o,
                sigma.utils.getY(a) - p,
                !0
              )),
              (b = k - d.x),
              (c = l - d.y),
              (b !== x.x || c !== x.y) &&
                ((m = x.x), (n = x.y), x.goTo({ x: b, y: c })),
        ...
        function i(a) {
          var b, c, d;
          return y("mouseEnabled")
            ? ((c = 1 / y("doubleClickZoomingRatio")),
              v.dispatchEvent("doubleclick", sigma.utils.mouseCoords(a, o, p)),
              y("doubleClickEnabled") &&
                ((b = x.cameraPosition(
                  sigma.utils.getX(a) - sigma.utils.getCenter(a).x,
                  sigma.utils.getY(a) - sigma.utils.getCenter(a).y,
                  !0
                )),
                (d = { duration: y("doubleClickZoomDuration") }),
        ...
        function j(a) {
          var b, c, d;
          return y("mouseEnabled") && y("mouseWheelEnabled")
            ? ((c =
                sigma.utils.getDelta(a) > 0
                  ? 1 / y("zoomingRatio")
                  : y("zoomingRatio")),
              (b = x.cameraPosition(
                sigma.utils.getX(a) - sigma.utils.getCenter(a).x,
              ...
              (d = { duration: y("mouseZoomDuration") }),
              sigma.utils.zoomTo(x, b.x, b.y, c, d),
              a.preventDefault ? a.preventDefault() : (a.returnValue = !1),
              a.stopPropagation(),
              !1)
  ...
  function () {
    ...
    sigma.utils.pkg("sigma.captors"),
      (sigma.captors.touch = function (a, b, c) {
            ...
            switch (
              ...
              case 1:
                (F = d(E[0])),
                  ...
                  (L !== C.x || M !== C.y) &&
                    ...
                    A.dispatchEvent(
                      "mousemove",
                      sigma.utils.mouseCoords(a, F.x, F.y)
                    ),
              ...
              case 2:
                (F = d(E[0])),
                  ...
                  (f = G.y),
                  (I = C.cameraPosition(
                    (q + s) / 2 - sigma.utils.getCenter(a).x,
                    (r + t) / 2 - sigma.utils.getCenter(a).y,
                    !0
                  )),
                  (B = C.cameraPosition(
                    (b + c) / 2 - sigma.utils.getCenter(a).x,
                    (e + f) / 2 - sigma.utils.getCenter(a).y,
                    !0
                  )),
                  ...
                  (L = b - B.x + i),
                  (M = e - B.y + j),
                  (N !== C.ratio || O !== C.angle || L !== C.x || M !== C.y) &&
                    ((m = C.x),
                    (n = C.y),
                    (o = C.angle),
                    (p = C.ratio),
                    C.goTo({ x: L, y: M, angle: O, ratio: N }),
                    A.dispatchEvent("drag"));
            }
        ...
        function h(a) {
          var b, c, e;
          return a.touches && 1 === a.touches.length && D("touchEnabled")
            ? ((y = !0),
              (c = 1 / D("doubleClickZoomingRatio")),
              (b = d(a.touches[0])),
              A.dispatchEvent(
                "doubleclick",
                sigma.utils.mouseCoords(a, b.x, b.y)
              ),
              D("doubleClickEnabled") &&
                ((b = C.cameraPosition(
                  b.x - sigma.utils.getCenter(a).x,
                  b.y - sigma.utils.getCenter(a).y,
                  !0
                )),
                (e = {
                ...
                sigma.utils.zoomTo(C, b.x, b.y, c, e)),
              a.preventDefault ? a.preventDefault() : (a.returnValue = !1),
              a.stopPropagation(),
              !1)
            : void 0;
    ...
    sigma.utils.pkg("sigma.renderers"),
      (sigma.renderers.canvas = function (a, b, c, d) {
        ...
        for (
          sigma.classes.dispatcher.extend(this),
            ...
            this.settings =
              "object" == typeof d.settings && d.settings
                ? c.embedObjects(d.settings)
                : c,
            this.nodesOnScreen = [],
            this.edgesOnScreen = [],
            this.jobs = {},
          ...
          (h = "function" == typeof g[e] ? g[e] : sigma.captors[g[e]]),
            this.captors.push(
              new h(this.domElements.mouse, this.camera, this.settings)
            );
      ...
      (sigma.renderers.canvas.prototype.render = function (b) {
        ...
        var c,
          ...
          w = this.settings.embedObjects(b, { prefix: this.options.prefix });
        this.resize(!1),
          this.settings(b, "hideEdgesOnMove") &&
        ...
        if (s) {
          for (c = q.edges(), d = 0, f = c.length; f > d; d++)
            (g = c[d]),
              (!p[g.source] && !p[g.target]) ||
                g.hidden ||
                r(g.source).hidden ||
                r(g.target).hidden ||
                this.edgesOnScreen.push(g);
          if (this.settings(b, "batchEdgesDrawing"))
            (h = "edges_" + this.conradId),
              (n = w("canvasEdgesBatchSize")),
              ...
              (j = function () {
                for (
                  o = this.contexts.edges.globalCompositeOperation,
                    this.contexts.edges.globalCompositeOperation =
                      "destination-over",
                    m = sigma.canvas.edges,
                    d = k;
                  i > d;
                  d++
                )
                  (g = l[d]),
                    (m[g.type || this.settings(b, "defaultEdgeType")] || m.def)(
                      g,
                      q.nodes(g.source),
                      q.nodes(g.target),
                      this.contexts.edges,
                ...
                if (v)
                  for (m = sigma.canvas.edges.labels, d = k; i > d; d++)
                    (g = l[d]),
                      g.hidden ||
                        (
                          m[g.type || this.settings(b, "defaultEdgeType")] ||
                          m.def
                        )(
                          g,
                          q.nodes(g.source),
                ...
                return (
                  (this.contexts.edges.globalCompositeOperation = o),
                  i === l.length
                    ? (delete this.jobs[h], !1)
                    : ((k = i + 1), (i = Math.min(l.length, k + n)), !0)
                );
              }),
              (this.jobs[h] = j),
            ...
            if (v)
              for (
                ...
                c[d].hidden ||
                  (
                    m[c[d].type || this.settings(b, "defaultEdgeType")] || m.def
                  )(
                    c[d],
                    q.nodes(c[d].source),
                    q.nodes(c[d].target),
        ...
        if (t)
          for (
            m = sigma.canvas.nodes, c = this.nodesOnScreen, d = 0, f = c.length;
            f > d;
            d++
          )
            c[d].hidden ||
              (m[c[d].type || this.settings(b, "defaultNodeType")] || m.def)(
                c[d],
                this.contexts.nodes,
                w
              );
      ...
      (sigma.renderers.canvas.prototype.initDOM = function (a, b) {
        ...
        (c.style.position = "absolute"),
          ...
          "canvas" === a.toLowerCase() &&
            (this.contexts[b] = c.getContext("2d"));
      }),
        ...
        if (
          ...
          for (d in this.domElements)
            (this.domElements[d].style.width = b + "px"),
              ...
              "canvas" === this.domElements[d].tagName.toLowerCase() &&
                (this.domElements[d].setAttribute("width", b * g + "px"),
      ...
      (sigma.renderers.canvas.prototype.kill = function () {
        ...
        for (a in this.domElements)
          this.domElements[a].parentNode.removeChild(this.domElements[a]),
            delete this.domElements[a],
            delete this.contexts[a];
  ...
  function (a) {
    ...
    sigma.utils.pkg("sigma.renderers"),
      (sigma.renderers.webgl = function (a, b, c, d) {
        ...
        for (
          sigma.classes.dispatcher.extend(this),
            ...
            this.settings(d, "batchEdgesDrawing")
      ...
      (sigma.renderers.webgl.prototype.process = function () {
        ...
        for (d in this.edgeIndicesArrays) delete this.edgeIndicesArrays[d];
        for (a = g.edges(), b = 0, c = a.length; c > b; b++)
          (e = a[b].type || i),
            (d = e && sigma.webgl.edges[e] ? e : "def"),
            this.edgeFloatArrays[d] ||
              (this.edgeFloatArrays[d] = { edges: [] }),
            this.edgeFloatArrays[d].edges.push(a[b]);
        for (a = g.nodes(), b = 0, c = a.length; c > b; b++)
          (e = a[b].type || j),
            (d = e && sigma.webgl.nodes[e] ? e : "def"),
            this.nodeFloatArrays[d] ||
              (this.nodeFloatArrays[d] = { nodes: [] }),
            this.nodeFloatArrays[d].nodes.push(a[b]);
        for (d in this.edgeFloatArrays) {
          for (
            f = sigma.webgl.edges[d],
              a = this.edgeFloatArrays[d].edges,
              this.edgeFloatArrays[d].array = new Float32Array(
                a.length * f.POINTS * f.ATTRIBUTES
              ),
              b = 0,
              c = a.length;
            c > b;
            ...
            a[b].hidden ||
              g.nodes(a[b].source).hidden ||
              g.nodes(a[b].target).hidden ||
              f.addEdge(
                a[b],
                g.nodes(a[b].source),
                g.nodes(a[b].target),
                this.edgeFloatArrays[d].array,
                b * f.POINTS * f.ATTRIBUTES,
                h.prefix,
                this.settings
              );
          "function" == typeof f.computeIndices &&
            (this.edgeIndicesArrays[d] = f.computeIndices(
              this.edgeFloatArrays[d].array
            ));
        }
        for (d in this.nodeFloatArrays)
          for (
            f = sigma.webgl.nodes[d],
              a = this.nodeFloatArrays[d].nodes,
              this.nodeFloatArrays[d].array = new Float32Array(
                a.length * f.POINTS * f.ATTRIBUTES
              ),
              b = 0,
              c = a.length;
      ...
      (sigma.renderers.webgl.prototype.render = function (b) {
        ...
        this.resize(!1),
          this.settings(m, "hideEdgesOnMove") &&
            (this.camera.isAnimated || this.camera.isMoving) &&
            (o = !1),
          this.clear(),
          (l = sigma.utils.matrices.multiply(
            l,
          ...
          if (this.settings(m, "batchEdgesDrawing"))
            (function () {
              ...
              (c = "edges_" + this.conradId),
                ...
                a.length &&
                  ((b = 0),
                  (i = sigma.webgl.edges[a[b]]),
                  (e = this.edgeFloatArrays[a[b]].array),
                  (h = this.edgeIndicesArrays[a[b]]),
                  (g = 0),
                  (f = Math.min(g + j * i.POINTS, e.length / i.ATTRIBUTES)),
                  (d = function () {
                    return (
                      this.edgePrograms[a[b]] ||
                        (this.edgePrograms[a[b]] = i.initProgram(k)),
                      f > g &&
                        (k.useProgram(this.edgePrograms[a[b]]),
                        i.render(k, this.edgePrograms[a[b]], e, {
                      ...
                      f >= e.length / i.ATTRIBUTES && b === a.length - 1
                        ? (delete this.jobs[c], !1)
                        : (f >= e.length / i.ATTRIBUTES
                            ? (b++,
                              (e = this.edgeFloatArrays[a[b]].array),
                              (i = sigma.webgl.edges[a[b]]),
                              (g = 0),
            ...
            for (f in this.edgeFloatArrays)
              (h = sigma.webgl.edges[f]),
                this.edgePrograms[f] ||
                  (this.edgePrograms[f] = h.initProgram(k)),
                this.edgeFloatArrays[f] &&
                  (k.useProgram(this.edgePrograms[f]),
                  h.render(
                    k,
                    this.edgePrograms[f],
                    this.edgeFloatArrays[f].array,
                    {
                      settings: this.settings,
                      matrix: l,
                      width: this.width,
        ...
        if (p) {
          ...
          for (f in this.nodeFloatArrays)
            (h = sigma.webgl.nodes[f]),
              ...
              this.nodeFloatArrays[f] &&
                (j.useProgram(this.nodePrograms[f]),
                h.render(
                  j,
                  this.nodePrograms[f],
                  this.nodeFloatArrays[f].array,
                  {
                    settings: this.settings,
                    matrix: l,
                    width: this.width,
        ...
        if (n)
          for (
            ...
            c[d].hidden ||
              (
                sigma.canvas.labels[
                  c[d].type || this.settings(m, "defaultNodeType")
                ] || sigma.canvas.labels.def
              )(c[d], this.contexts.labels, g);
        return this.dispatchEvent("render"), this;
      }),
      (sigma.renderers.webgl.prototype.initDOM = function (a, b, c) {
        ...
        (d.style.position = "absolute"),
          ...
          "canvas" === a.toLowerCase() &&
            ((this.contexts[b] = d.getContext(c ? "experimental-webgl" : "2d", {
        ...
        if (
          ...
          for (d in this.domElements)
            (this.domElements[d].style.width = b + "px"),
              (this.domElements[d].style.height = c + "px"),
              "canvas" === this.domElements[d].tagName.toLowerCase() &&
                (this.contexts[d] && this.contexts[d].scale
                  ? (this.domElements[d].setAttribute("width", b * g + "px"),
                    this.domElements[d].setAttribute("height", c * g + "px"),
                    1 !== g && this.contexts[d].scale(g, g))
                  : (this.domElements[d].setAttribute(
                      "width",
                      b * this.settings("webglOversamplingRatio") + "px"
                    ),
                    this.domElements[d].setAttribute(
                      "height",
    ...
    sigma.utils.pkg("sigma.renderers"),
      (sigma.renderers.svg = function (a, b, c, d) {
        ...
        for (
          ...
          (h = "function" == typeof g[e] ? g[e] : sigma.captors[g[e]]),
            this.captors.push(
              new h(this.domElements.graph, this.camera, this.settings)
            );
        window.addEventListener("resize", function () {
          i.resize();
        }),
      ...
      (sigma.renderers.svg.prototype.render = function (b) {
        ...
        var c,
          ...
          q =
            (this.settings(b, "drawLabels"),
            this.settings.embedObjects(b, {
        ...
        if (((j = sigma.svg.nodes), (k = sigma.svg.labels), p))
          for (c = this.nodesOnScreen, d = 0, f = c.length; f > d; d++)
            c[d].hidden ||
              this.domElements.nodes[c[d].id] ||
              ((e = (j[c[d].type] || j.def).create(c[d], q)),
              (this.domElements.nodes[c[d].id] = e),
              this.domElements.groups.nodes.appendChild(e),
              (e = (k[c[d].type] || k.def).create(c[d], q)),
              (this.domElements.labels[c[d].id] = e),
              this.domElements.groups.labels.appendChild(e));
        if (p)
          for (c = this.nodesOnScreen, d = 0, f = c.length; f > d; d++)
            c[d].hidden ||
              ((j[c[d].type] || j.def).update(
                c[d],
                this.domElements.nodes[c[d].id],
                q
              ),
              (k[c[d].type] || k.def).update(
                c[d],
                this.domElements.labels[c[d].id],
                q
              ));
        if (((j = sigma.svg.edges), o))
          for (c = this.edgesOnScreen, d = 0, f = c.length; f > d; d++)
            this.domElements.edges[c[d].id] ||
              ((h = n(c[d].source)),
              (i = n(c[d].target)),
              (e = (j[c[d].type] || j.def).create(c[d], h, i, q)),
              (this.domElements.edges[c[d].id] = e),
      ...
      (sigma.renderers.svg.prototype.initDOM = function (a) {
        ...
        for (d = 0, c = h.length; c > d; d++)
          (b = document.createElementNS(this.settings("xmlns"), "g")),
            b.setAttributeNS(null, "id", f + "-group-" + h[d]),
            b.setAttributeNS(null, "class", f + "-group"),
            (this.domElements.groups[h[d]] =
              this.domElements.graph.appendChild(b));
      ...
      (sigma.renderers.svg.prototype.bindHovers = function (a) {
        function b(b) {
          var c = b.data.node,
            d = g.settings.embedObjects({ prefix: a });
          if (d("enableHovering")) {
            var h = (f[c.type] || f.def).create(
              c,
              g.domElements.nodes[c.id],
              g.measurementCanvas,
              d
            );
        ...
        function c(b) {
          var c = b.data.node,
            d = g.settings.embedObjects({ prefix: a });
          d("enableHovering") &&
            (g.domElements.groups.hovers.removeChild(
              g.domElements.hovers[c.id]
            ),
            (e = null),
            delete g.domElements.hovers[c.id],
            g.domElements.groups.nodes.appendChild(g.domElements.nodes[c.id]));
        }
        function d() {
          if (e) {
            ...
            var c = (f[e.type] || f.def).create(
              e,
              g.domElements.nodes[e.id],
              g.measurementCanvas,
              b
            );
        ...
        return (
          b !== a && c !== a
            ...
            : ((this.width = this.container.offsetWidth),
              ...
              (b = this.width),
              (c = this.height)),
          (d !== this.width || e !== this.height) &&
            ((this.domElements.graph.style.width = b + "px"),
            (this.domElements.graph.style.height = c + "px"),
            "svg" === this.domElements.graph.tagName.toLowerCase() &&
              (this.domElements.graph.setAttribute("width", b * f),
              this.domElements.graph.setAttribute("height", c * f))),
          this
        );
      }),
        ...
        render: function (a, b, c, d) {
          ...
          (e = a.createBuffer()),
            ...
            a.drawArrays(
              a.TRIANGLES,
              d.start || 0,
              d.count || c.length / this.ATTRIBUTES
            );
        },
        initProgram: function (a) {
          var b, c, d;
          return (
            (b = sigma.utils.loadShader(
              a,
              [
      ...
      (sigma.webgl.edges.def = {
        ...
        render: function (a, b, c, d) {
          ...
          (e = a.createBuffer()),
            ...
            a.uniform1f(
              o,
              d.ratio / Math.pow(d.ratio, d.settings("edgesPowRatio"))
            ),
            ...
            a.uniformMatrix2fv(
              m,
              !1,
              sigma.utils.matrices.rotation(Math.PI / 2, !0)
            ),
            a.uniformMatrix2fv(
              n,
              !1,
      ...
      (sigma.webgl.edges.arrow = {
        ...
        render: function (a, b, c, d) {
          ...
          (e = a.createBuffer()),
            ...
            a.uniform1f(
              t,
              Math.pow(d.ratio, d.settings("nodesPowRatio")) / d.ratio
            ),
            a.uniform1f(u, 5),
  ...
  function () {
    ...
    sigma.utils.pkg("sigma.canvas.labels"),
      (sigma.canvas.labels.def = function (a, b, c) {
        ...
        f < c("labelThreshold") ||
          (a.label &&
            "string" == typeof a.label &&
            ((d =
              "fixed" === c("labelSize")
                ? c("defaultLabelSize")
                : c("labelSizeRatio") * f),
            (b.font =
              (c("fontStyle") ? c("fontStyle") + " " : "") +
              d +
              "px " +
              c("font")),
            (b.fillStyle =
              "node" === c("labelColor")
                ? a.color || c("defaultNodeColor")
                : c("defaultLabelColor")),
            b.fillText(
              a.label,
              Math.round(a[e + "x"] + f + 3),
              Math.round(a[e + "y"] + d / 3)
            )));
      });
  }.call(this),
  function () {
      ...
      (sigma.canvas.hovers.def = function (a, b, c) {
        var d,
          ...
          l =
            "fixed" === c("labelSize")
              ...
              : c("labelSizeRatio") * k;
        (b.font =
          (i ? i + " " : "") + l + "px " + (c("hoverFont") || c("font"))),
          b.beginPath(),
          (b.fillStyle =
            "node" === c("labelHoverBGColor")
              ? a.color || c("defaultNodeColor")
              : c("defaultHoverLabelBGColor")),
          a.label &&
            c("labelHoverShadow") &&
            ((b.shadowOffsetX = 0),
            (b.shadowOffsetY = 0),
          ...
          c("borderSize") > 0 &&
            (b.beginPath(),
            (b.fillStyle =
              "node" === c("nodeBorderColor")
                ? a.color || c("defaultNodeColor")
                : c("defaultNodeBorderColor")),
            b.arc(
              a[j + "x"],
              a[j + "y"],
              k + c("borderSize"),
        ...
        m(a, b, c),
          a.label &&
            "string" == typeof a.label &&
            ((b.fillStyle =
              "node" === c("labelHoverColor")
                ? a.color || c("defaultNodeColor")
                : c("defaultLabelHoverColor")),
            b.fillText(
              a.label,
              Math.round(a[j + "x"] + k + 3),
              Math.round(a[j + "y"] + l / 3)
            ));
      });
  }.call(this),
  (function () {
    ...
    sigma.utils.pkg("sigma.canvas.edges"),
      (sigma.canvas.edges.curve = function (a, b, c, d, e) {
        ...
        if (
          ((l =
            b.id === c.id
              ? sigma.utils.getSelfLoopControlPoints(n, o, m)
              : sigma.utils.getQuadraticControlPoint(n, o, p, q)),
          !f)
        )
          switch (i) {
            case "source":
        ...
        (d.strokeStyle = f),
          ...
          d.moveTo(n, o),
          b.id === c.id
            ? d.bezierCurveTo(l.x1, l.y1, l.x2, l.y2, p, q)
            : d.quadraticCurveTo(l.x, l.y, p, q),
          d.stroke();
      });
  })(),
  (function () {
  ...
  (function () {
    "use strict";
    sigma.utils.pkg("sigma.canvas.edges"),
      (sigma.canvas.edges.curvedArrow = function (a, b, c, d, e) {
        var f,
          g,
          h,
          i,
        ...
        if (
          ((p =
            b.id === c.id
              ? sigma.utils.getSelfLoopControlPoints(s, t, r)
              : sigma.utils.getQuadraticControlPoint(s, t, u, v)),
          b.id === c.id
            ? ((f = Math.sqrt(Math.pow(u - p.x1, 2) + Math.pow(v - p.y1, 2))),
              (g = p.x1 + ((u - p.x1) * (f - w - r)) / f),
              (h = p.y1 + ((v - p.y1) * (f - w - r)) / f),
              (i = ((u - p.x1) * w) / f),
              (j = ((v - p.y1) * w) / f))
            : ((f = Math.sqrt(Math.pow(u - p.x, 2) + Math.pow(v - p.y, 2))),
              (g = p.x + ((u - p.x) * (f - w - r)) / f),
              (h = p.y + ((v - p.y) * (f - w - r)) / f),
              (i = ((u - p.x) * w) / f),
              (j = ((v - p.y) * w) / f)),
        ...
        (d.strokeStyle = k),
          ...
          d.moveTo(s, t),
          b.id === c.id
            ? d.bezierCurveTo(p.x2, p.y2, p.x1, p.y1, g, h)
            : d.quadraticCurveTo(p.x, p.y, g, h),
          d.stroke(),
          (d.fillStyle = k),
          d.beginPath(),
          d.moveTo(g + i, h + j),
          d.lineTo(g + 0.6 * j, h - 0.6 * i),
          d.lineTo(g - 0.6 * j, h + 0.6 * i),
          d.lineTo(g + i, h + j),
          d.closePath(),
          d.fill();
    ...
    sigma.utils.pkg("sigma.canvas.edgehovers"),
      (sigma.canvas.edgehovers.curvedArrow = function (a, b, c, d, e) {
        ...
        if (
          ((q =
            b.id === c.id
              ? sigma.utils.getSelfLoopControlPoints(t, u, s)
              : sigma.utils.getQuadraticControlPoint(t, u, v, w)),
          b.id === c.id
            ? ((f = Math.sqrt(Math.pow(v - q.x1, 2) + Math.pow(w - q.y1, 2))),
              (g = 2.5 * r),
              (h = q.x1 + ((v - q.x1) * (f - g - s)) / f),
              (i = q.y1 + ((w - q.y1) * (f - g - s)) / f),
              (j = ((v - q.x1) * g) / f),
              (k = ((w - q.y1) * g) / f))
            : ((f = Math.sqrt(Math.pow(v - q.x, 2) + Math.pow(w - q.y, 2))),
              (g = 2.5 * r),
              (h = q.x + ((v - q.x) * (f - g - s)) / f),
              (i = q.y + ((w - q.y) * (f - g - s)) / f),
              (j = ((v - q.x) * g) / f),
        ...
        (l =
          "edge" === e("edgeHoverColor")
            ? a.hover_color || l
            : a.hover_color || e("defaultEdgeHoverColor") || l),
          (d.strokeStyle = l),
          (d.lineWidth = r),
          d.beginPath(),
          d.moveTo(t, u),
          b.id === c.id
            ? d.bezierCurveTo(q.x2, q.y2, q.x1, q.y1, h, i)
            : d.quadraticCurveTo(q.x, q.y, h, i),
          d.stroke(),
          (d.fillStyle = l),
          d.beginPath(),
          d.moveTo(h + j, i + k),
          d.lineTo(h + 0.6 * k, i - 0.6 * j),
          d.lineTo(h - 0.6 * k, i + 0.6 * j),
          d.lineTo(h + j, i + k),
          d.closePath(),
          d.fill();
  ...
  (function () {
    ...
    sigma.utils.pkg("sigma.svg.nodes"),
      (sigma.svg.nodes.def = {
        create: function (a, b) {
          var c =
            (b("prefix") || "", document.createElementNS(b("xmlns"), "circle"));
          return (
            c.setAttributeNS(null, "data-node-id", a.id),
        ...
        update: function (a, b, c) {
          var d = c("prefix") || "";
          return (
            b.setAttributeNS(null, "cx", a[d + "x"]),
            b.setAttributeNS(null, "cy", a[d + "y"]),
            b.setAttributeNS(null, "r", a[d + "size"]),
            c("freeStyle") ||
              b.setAttributeNS(null, "fill", a.color || c("defaultNodeColor")),
            (b.style.display = ""),
            this
          );
        },
    ...
    sigma.utils.pkg("sigma.svg.edges"),
      (sigma.svg.edges.def = {
        create: function (a, b, c, d) {
          ...
          return (
            i.setAttributeNS(null, "data-edge-id", a.id),
      ...
      (sigma.svg.labels.def = {
        create: function (a, b) {
          var c = b("prefix") || "",
            ...
            g =
              "node" === b("labelColor")
                ? a.color || b("defaultNodeColor")
                : b("defaultLabelColor");
          return (
            e.setAttributeNS(null, "data-label-target", a.id),
          ...
          var d = c("prefix") || "",
            ...
            f =
              "fixed" === c("labelSize")
                ? c("defaultLabelSize")
                : c("labelSizeRatio") * e;
          return (!c("forceLabels") && e < c("labelThreshold")) ||
            "string" != typeof a.label
            ? void 0
            : (b.setAttributeNS(null, "x", Math.round(a[d + "x"] + e + 3)),
              b.setAttributeNS(null, "y", Math.round(a[d + "y"] + f / 3)),
              (b.style.display = ""),
              this);
        },
      });
    ...
    sigma.utils.pkg("sigma.svg.hovers"),
      (sigma.svg.hovers.def = {
        create: function (a, b, c, d) {
          var e,
            ...
            l =
              "fixed" === d("labelSize")
                ...
                : d("labelSizeRatio") * k,
            m =
              "node" === d("labelHoverColor")
                ? a.color || d("defaultNodeColor")
                : d("defaultLabelHoverColor"),
          ...
          return (
            n.setAttributeNS(null, "class", d("classPrefix") + "-hover"),
            ...
            "string" == typeof a.label &&
              ...
              q.setAttributeNS(
                null,
                "class",
                d("classPrefix") + "-hover-label"
              ),
              q.setAttributeNS(null, "font-size", l),
              q.setAttributeNS(null, "font-family", d("font")),
              q.setAttributeNS(null, "fill", m),
              q.setAttributeNS(null, "x", Math.round(a[j + "x"] + k + 3)),
              q.setAttributeNS(null, "y", Math.round(a[j + "y"] + l / 3)),
              (e = Math.round(a[j + "x"] - l / 2 - 2)),
              (f = Math.round(a[j + "y"] - l / 2 - 2)),
              (g = Math.round(c.measureText(a.label).width + l / 2 + k + 9)),
              (h = Math.round(l + 4)),
              (i = Math.round(l / 2 + 2)),
              p.setAttributeNS(null, "class", d("classPrefix") + "-hover-area"),
              p.setAttributeNS(null, "fill", "#fff"),
              p.setAttributeNS(null, "cx", a[j + "x"]),
              p.setAttributeNS(null, "cy", a[j + "y"]),
              p.setAttributeNS(null, "r", i),
              o.setAttributeNS(null, "class", d("classPrefix") + "-hover-area"),
              o.setAttributeNS(null, "fill", "#fff"),
              o.setAttributeNS(null, "x", a[j + "x"] + i / 4),
              o.setAttributeNS(null, "y", a[j + "y"] - i),
              o.setAttributeNS(null, "width", g),
              o.setAttributeNS(null, "height", h)),
            n.appendChild(p),
            n.appendChild(o),
            n.appendChild(q),
            n.appendChild(b),
    ...
    sigma.utils.pkg("sigma.middlewares"),
      ...
      (sigma.middlewares.rescale = function (a, b, c) {
        var d,
          ...
          w = n("height") || 1,
          x = n("autoRescale"),
          y = { nodePosition: 1, nodeSize: 1, edgeSize: 1 };
        for (
          ...
          if (!y[x[d]])
            throw new Error(
              'The rescale setting "' + x[d] + '" is not recognized.'
            );
        ...
        for (
          j =
            "outside" === n("scalingMode")
              ? Math.max(v / Math.max(r - p, 1), w / Math.max(s - q, 1))
              : Math.min(v / Math.max(r - p, 1), w / Math.max(s - q, 1)),
            k =
              (n("rescaleIgnoreSize") ? 0 : (n("maxNodeSize") || t) / j) +
              (n("sideMargin") || 0),
            r += k,
            p -= k,
            s += k,
            ...
            j =
              "outside" === n("scalingMode")
                ? Math.max(v / Math.max(r - p, 1), w / Math.max(s - q, 1))
                : Math.min(v / Math.max(r - p, 1), w / Math.max(s - q, 1)),
            n("maxNodeSize") || n("minNodeSize")
              ? n("maxNodeSize") === n("minNodeSize")
                ? ((f = 0), (g = +n("maxNodeSize")))
                : ((f = (n("maxNodeSize") - n("minNodeSize")) / t),
                  (g = +n("minNodeSize")))
              : ((f = 1), (g = 0)),
            n("maxEdgeSize") || n("minEdgeSize")
              ? n("maxEdgeSize") === n("minEdgeSize")
                ? ((h = 0), (i = +n("minEdgeSize")))
                : ((h = (n("maxEdgeSize") - n("minEdgeSize")) / u),
                  (i = +n("minEdgeSize")))
              : ((h = 1), (i = 0)),
            d = 0,
            e = m.length;
        ...
        for (d = 0, e = l.length; e > d; d++)
          (l[d][b + "size"] = l[d][a + "size"] * (A ? f : 1) + (A ? g : 0)),
            (l[d][b + "x"] = (l[d][a + "x"] - (r + p) / 2) * (z ? j : 1)),
            (l[d][b + "y"] = (l[d][a + "y"] - (s + q) / 2) * (z ? j : 1));
      }),
      (sigma.utils.getBoundaries = function (a, b, c) {
        ...
        return (
          (h = h || 1),
          (i = i || 1),
          { weightMax: h, sizeMax: i, minX: j, minY: k, maxX: l, maxY: m }
        );
      });
  }.call(this),
  function () {
  ...
  function (a) {
    ...
    (sigma.misc.animation.camera = function (c, d, e) {
      ...
      if (
        "number" != typeof d.x &&
        "number" != typeof d.y &&
        "number" != typeof d.ratio &&
        "number" != typeof d.angle
      )
      ...
      return (
        (k = { x: c.x, y: c.y, ratio: c.ratio, angle: c.angle }),
        (j = l.duration),
        (i =
          ...
          e >= 1
            ...
            : ((b = i(e)),
              ...
              c.goTo({
                ...
                ratio:
                  d.ratio !== a ? k.ratio + (d.ratio - k.ratio) * b : k.ratio,
                angle:
                  d.angle !== a ? k.angle + (d.angle - k.angle) * b : k.angle,
              }),
      ...
      (sigma.misc.animation.kill = function (a) {
        ...
        return (
          b &&
            ...
            "function" == typeof (b.options || {}).onComplete &&
      ...
      (sigma.misc.animation.killAll = function (a) {
        ...
        for (c in g)
          (e && g[c].type !== e) ||
            (f && g[c].target !== f) ||
            ((b = sigma.misc.animation.running[c]),
  ...
  function (a) {
    ...
    sigma.utils.pkg("sigma.misc"),
      (sigma.misc.bindEvents = function (b) {
        function c(a) {
          a &&
            ((h = "x" in a.data ? a.data.x : h),
            (i = "y" in a.data ? a.data.y : i));
          var c,
            d,
            e,
            f,
            ...
            for (c = 0, e = r.length; e > c; c++)
              if (
                ...
                !f.hidden &&
                  ...
                  p > k - l &&
                  k + l > p &&
                  Math.sqrt(Math.pow(o - g, 2) + Math.pow(p - k, 2)) < l)
              ) {
        ...
        function d(c) {
          ...
          c &&
            ((h = "x" in c.data ? c.data.x : h),
            (i = "y" in c.data ? c.data.y : i));
          var f,
            g,
            k,
            l,
            ...
            y = [];
          if (e) {
            var z = j.camera.quadtree.area(
              j.camera.getRectangle(j.width, j.height)
            );
            for (l = z, f = 0, k = l.length; k > f; f++) t[l[f].id] = l[f];
          }
          if (
            (j.camera.edgequadtree !== a &&
              (y = j.camera.edgequadtree.point(x.x, x.y)),
            y.length)
          )
            for (f = 0, k = y.length; k > f; f++)
              (m = y[f]),
                (o = j.graph.nodes(m.source)),
                (p = j.graph.nodes(m.target)),
                (n = m[b + "size"] || m["read_" + b + "size"]),
                !m.hidden &&
                  !o.hidden &&
                  !p.hidden &&
                  (!e || t[m.source] || t[m.target]) &&
                  sigma.utils.getDistance(o[b + "x"], o[b + "y"], v, w) >
                    o[b + "size"] &&
                  sigma.utils.getDistance(p[b + "x"], p[b + "y"], v, w) >
                    p[b + "size"] &&
                  ("curve" == m.type || "curvedArrow" == m.type
                    ? o.id === p.id
                      ? ((q = sigma.utils.getSelfLoopControlPoints(
                          o[b + "x"],
                          o[b + "y"],
                          o[b + "size"]
                        )),
                      ...
                      : ((q = sigma.utils.getQuadraticControlPoint(
                          o[b + "x"],
                          o[b + "y"],
                          p[b + "x"],
                          p[b + "y"]
        ...
        function e(a) {
          function b(a) {
            j.settings("eventsEnabled") &&
              (j.dispatchEvent("click", a.data),
              (i = c(a)),
              (k = d(a)),
              i.length
                ? (j.dispatchEvent("clickNode", { node: i[0], captor: a.data }),
                  j.dispatchEvent("clickNodes", { node: i, captor: a.data }))
                : k.length
                ? (j.dispatchEvent("clickEdge", { edge: k[0], captor: a.data }),
                  j.dispatchEvent("clickEdges", { edge: k, captor: a.data }))
                : j.dispatchEvent("clickStage", { captor: a.data }));
          }
          function e(a) {
            j.settings("eventsEnabled") &&
              (j.dispatchEvent("doubleClick", a.data),
              (i = c(a)),
              (k = d(a)),
              i.length
                ? (j.dispatchEvent("doubleClickNode", {
                    node: i[0],
                    captor: a.data,
                  }),
                ...
                : k.length
                ? (j.dispatchEvent("doubleClickEdge", {
                    edge: k[0],
                    captor: a.data,
                  }),
          ...
          function f(a) {
            j.settings("eventsEnabled") &&
              (j.dispatchEvent("rightClick", a.data),
              (i = c(a)),
              (k = d(a)),
              i.length
                ? (j.dispatchEvent("rightClickNode", {
                    node: i[0],
                    captor: a.data,
                  }),
                ...
                : k.length
                ? (j.dispatchEvent("rightClickEdge", {
                    edge: k[0],
                    captor: a.data,
                  }),
          ...
          function g(a) {
            if (j.settings("eventsEnabled")) {
              ...
              for (l = {}, c = 0, d = f.length; d > c; c++)
                j.dispatchEvent("outNode", { node: f[c], captor: a.data });
              for (
                f.length &&
                  j.dispatchEvent("outNodes", { nodes: f, captor: a.data }),
                  m = {},
                  c = 0,
                  e = g.length;
                e > c;
                ...
                j.dispatchEvent("outEdge", { edge: g[c], captor: a.data });
              g.length &&
                j.dispatchEvent("outEdges", { edges: g, captor: a.data });
            }
          }
          function h(a) {
            if (j.settings("eventsEnabled")) {
              ...
              for (b = 0; p > b; b++)
                (f = i[b]),
                  (o[f.id] = f),
                  l[f.id] || (n.push(f), (l[f.id] = f));
              for (e in l) o[e] || (h.push(l[e]), delete l[e]);
              for (b = 0, p = n.length; p > b; b++)
                j.dispatchEvent("overNode", { node: n[b], captor: a.data });
              for (b = 0, p = h.length; p > b; b++)
                j.dispatchEvent("outNode", { node: h[b], captor: a.data });
              for (
                n.length &&
                  j.dispatchEvent("overNodes", { nodes: n, captor: a.data }),
                  h.length &&
                    j.dispatchEvent("outNodes", { nodes: h, captor: a.data }),
                  b = 0;
                t > b;
                b++
              )
                (g = k[b]),
                  (s[g.id] = g),
                  m[g.id] || (r.push(g), (m[g.id] = g));
              for (e in m) s[e] || (q.push(m[e]), delete m[e]);
              for (b = 0, t = r.length; t > b; b++)
                j.dispatchEvent("overEdge", { edge: r[b], captor: a.data });
              for (b = 0, t = q.length; t > b; b++)
                j.dispatchEvent("outEdge", { edge: q[b], captor: a.data });
              r.length &&
                j.dispatchEvent("overEdges", { edges: r, captor: a.data }),
                q.length &&
                  j.dispatchEvent("outEdges", { edges: q, captor: a.data });
            }
          }
          var i,
            k,
      ...
      (sigma.misc.bindDOMEvents = function (a) {
        ...
        function d(a) {
          if (g.settings("eventsEnabled")) {
            ...
            var c = new b(a.target);
            c.isNode()
              ? g.dispatchEvent("doubleClickNode", {
                  node: h.nodes(c.attr("data-node-id")),
                })
      ...
      (sigma.misc.drawHovers = function (a) {
        function b() {
          var b,
            ...
            p = c.settings.embedObjects({ prefix: a });
          if (
            (c.contexts.hover.clearRect(0, 0, j.width, j.height),
            p("enableHovering") &&
              p("singleHover") &&
              Object.keys(d).length &&
              ((h = d[Object.keys(d)[0]]),
              (m[h.type] || m[k] || m.def)(h, c.contexts.hover, p)),
            p("enableHovering") && !p("singleHover"))
          )
            for (b in d)
              (m[d[b].type] || m[k] || m.def)(d[b], c.contexts.hover, p);
          if (
            (p("enableEdgeHovering") &&
              p("singleHover") &&
              Object.keys(e).length &&
              ((i = e[Object.keys(e)[0]]),
              (f = c.graph.nodes(i.source)),
              (g = c.graph.nodes(i.target)),
              i.hidden ||
                ((n[i.type] || n[l] || n.def)(i, f, g, c.contexts.hover, p),
                p("edgeHoverExtremities")
                  ? (o[i.type] || o.def)(i, f, g, c.contexts.hover, p)
                  : ((sigma.canvas.nodes[f.type] || sigma.canvas.nodes.def)(
                      f,
                      c.contexts.hover,
                      p
                    ),
                    (sigma.canvas.nodes[g.type] || sigma.canvas.nodes.def)(
                      g,
                      c.contexts.hover,
                      p
                    )))),
            p("enableEdgeHovering") && !p("singleHover"))
          )
            for (b in e)
              (i = e[b]),
                (f = c.graph.nodes(i.source)),
